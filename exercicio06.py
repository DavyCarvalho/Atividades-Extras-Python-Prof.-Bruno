...
#Elabore uma função que identifica e mostra na tela todos os quadrados mágicos com 
# as características acima. Dica: produza todas as combinações possíveis e verifique a soma 
